    ...
    return (
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <p>Precio mínimo: ${subasta.precio_minimo}</p>

                {error && <div className="error-mensaje">{error}</div>}

                <div className="montos-sugeridos">
                    <button onClick={() => handlePujarConMonto(montosSugeridos[0])}>
                        +10 (${montosSugeridos[0]})
                    </button>
                    <button onClick={() => handlePujarConMonto(montosSugeridos[1])}>
                        +50 (${montosSugeridos[1]})
                    </button>
                    <button onClick={() => handlePujarConMonto(montosSugeridos[2])}>
                        +100 (${montosSugeridos[2]})
                    </button>
                </div>
                ...
                <div className="monto-personalizado">
                    ...
                    />
                    <button onClick={handlePujarPersonalizado} disabled={cargando}>
                        Pujar
                    </button>
                </div>
